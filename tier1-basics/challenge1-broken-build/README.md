...
A developer pushed a Dockerfile that will not build. The CI pipeline is failing and the team is blocked. Your mission: fix the Dockerfile so it builds successfully.
...
The base image reference and COPY instruction both have issues.
</details>

<details>
<summary>Hint 3 (spicy)</summary>
FROM needs a valid image, COPY needs the source file to exist, and RUN commands need valid syntax.
</details>
